...
public class azNoSuchSessionException {

	public static void main(String[] args) {//no such element exception
...
"D:\\WorkSpace\\inmakes\\maven\\projectMaven\\driver\\chromedriver.exe");
		...
		//when we try to access the session data after quiting or closing
	}
